...
class UploadPatchTask extends DefaultTask {
    ...
    def init() {
        ...
        config = new Config()
        config.serverUrl = buildConfigUtil.getDebugBuildType("HOTFIX_SERVER_URL")
        config.applicationId = buildConfigUtil.getDebugBuildType("APPLICATION_ID")
        config.restApiKey = buildConfigUtil.getDebugBuildType("REST_API_KEY")
